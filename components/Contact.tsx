...
const Contact = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4" id="contact">
            ...
            {socials.map((social) => {
              ...
              return (
                <a
                  ...
                  className="block p-3 bg-white/50 dark:bg-zinc-800/50 rounded-lg hover:shadow-lg transition-all duration-300"
                >
